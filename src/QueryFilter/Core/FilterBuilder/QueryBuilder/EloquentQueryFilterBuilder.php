...
use LaroFilters\QueryFilter\Core\ResolverDetection\ResolverDetectionEloquent;
use LaroFilters\QueryFilter\Core\ResolverDetection\ResolverDetections;
use LaroFilters\QueryFilter\Factory\QueryBuilderWrapperFactory;
...
class EloquentQueryFilterBuilder extends QueryFilterBuilder
{
    ...
    /**
     * @param \LaroFilters\QueryFilter\Core\EloquentBuilder\EloquentModelBuilderWrapper $queryBuilderWrapper
     */
    ...
    private function resolveDetections($detections_injected, $black_list_detections)
    {
        ...
        /** @see \LaroFilters\QueryFilter\Core\ResolverDetection\ResolverDetectionEloquent */
