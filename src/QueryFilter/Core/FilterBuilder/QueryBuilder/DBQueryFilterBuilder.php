...
use LaroFilters\QueryFilter\Core\ResolverDetection\ResolverDetectionDb;
...
class DBQueryFilterBuilder extends QueryFilterBuilder
{
    ...
    /**
     * @param \LaroFilters\QueryFilter\Core\DbBuilder\DbBuilderWrapperInterface $queryBuilderWrapper
     */
    ...
    private function resolveDetections($detections_injected, $black_list_detections)
    {
        ...
        /** @see \LaroFilters\QueryFilter\Core\ResolverDetection\ResolverDetectionDb */
