...
use LaroFilters\QueryFilter\Detection\DetectionFactory\DetectionEloquentFactory;
...
class QueryFilterCoreBuilder implements QueryFilterCore
{
    ...
    /**
     * @return \LaroFilters\QueryFilter\Detection\Contract\MainBuilderConditionsContract
     */
    ...
    /**
     * @param \LaroFilters\QueryFilter\Detection\Contract\DetectorDbFactoryContract $detect_factory
     */
    ...
    /**
     * @return \LaroFilters\QueryFilter\Detection\Contract\DetectorDbFactoryContract
     */
     ...
     * @param array|null $detectInjected
     *
     * @return \LaroFilters\QueryFilter\Detection\DetectionFactory\DetectionDbFactory
     */
