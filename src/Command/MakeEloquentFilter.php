...
class MakeEloquentFilter extends Command
{
     ...
     * @var string
     */
    protected $signature = 'laro-filters:filter {name}';
     ...
     * @var string
     */
    protected $description = 'Create A New Custom Model Filter';
    ...
    public function makeClassName()
    {
        ...
        $fqClass = config('laroFilters.namespace', 'App\\ModelFilters\\').$ns.$className;
