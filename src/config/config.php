...
return [
     ...
     */
    'enabled' => env('LaroFilters_ENABLED', true),

    /*
     * Enable / disable Custom Detection EloquentFilter.
     */
    'enabled_custom_detection' => env('LaroFilters_Custom_Detection_ENABLED', true),
    ...
    */
    'rate_limit' => [
        ...
        'enabled' => env('LaroFilters_RATE_LIMIT_ENABLED', false),

        // Maximum number of attempts within the decay minutes
        'max_attempts' => env('LaroFilters_RATE_LIMIT', 60),

        // Number of minutes until the rate limit resets
        'decay_minutes' => env('LaroFilters_RATE_DECAY', 1),

        // Whether to include rate limit headers in the response
        'include_headers' => env('LaroFilters_RATE_LIMIT_HEADERS', true),

        // Custom response message when rate limit is exceeded
        'error_message' => env('LaroFilters_RATE_LIMIT_MESSAGE', 'Too many filter requests. Please try again later.'),
    ],
    ...
    */
    'cache' => [
        ...
        'prefix' => 'laro_filters_rate_limit:',

        // Cache store to use for rate limiting
        'store' => env('LaroFilters_CACHE_DRIVER', null),
    ],
];
