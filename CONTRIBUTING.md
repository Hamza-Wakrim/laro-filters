...
- Perform a [cursory search](https://github.com/hamza-wakrim/laro-filters/issues) to see if the issue has already been reported. If it has, add a comment to the existing issue instead of opening a new one.

**How Do I Submit A (Good) Bug Report?**

Bugs are tracked as [GitHub issues](https://github.com/hamza-wakrim/laro-filters/issues). Create an issue and provide the following information:
...
- [Beginner issues](https://github.com/hamza-wakrim/laro-filters/labels/beginner)
- [Help wanted issues](https://github.com/hamza-wakrim/laro-filters/labels/help%20wanted)
